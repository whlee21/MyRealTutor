package io.blocko.myrealtutor.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MyRealTutor");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MyRealTutor");
        ...
        config.getMapConfigs().put("io.blocko.myrealtutor.domain.*", initializeDomainMapConfig(jHipsterProperties));
