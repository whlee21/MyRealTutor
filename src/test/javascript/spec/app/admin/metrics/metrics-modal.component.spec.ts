...
import { MrtMetricsMonitoringModalComponent } from 'app/admin/metrics/metrics-modal.component';
import { MrtMetricsService } from 'app/admin/metrics/metrics.service';

describe('Component Tests', () => {
    describe('MrtMetricsMonitoringModalComponent', () => {
        let comp: MrtMetricsMonitoringModalComponent;
        let fixture: ComponentFixture<MrtMetricsMonitoringModalComponent>;
        ...
        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    ...
                    declarations: [MrtMetricsMonitoringModalComponent]
                })
                    .overrideTemplate(MrtMetricsMonitoringModalComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(MrtMetricsMonitoringModalComponent);
