...
import { MrtHealthCheckComponent } from 'app/admin/health/health.component';
import { MrtHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('MrtHealthCheckComponent', () => {
        let comp: MrtHealthCheckComponent;
        let fixture: ComponentFixture<MrtHealthCheckComponent>;
        let service: MrtHealthService;

        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    imports: [MyRealTutorTestModule],
                    declarations: [MrtHealthCheckComponent]
                })
                    .overrideTemplate(MrtHealthCheckComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(MrtHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(MrtHealthService);
        });
