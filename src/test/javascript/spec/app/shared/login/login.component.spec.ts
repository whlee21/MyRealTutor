...
import { MrtLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: MrtLoginModalComponent;
        let fixture: ComponentFixture<MrtLoginModalComponent>;
        ...
        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    ...
                    declarations: [MrtLoginModalComponent],
                    providers: [
                        {
                    ...
                    .overrideTemplate(MrtLoginModalComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(MrtLoginModalComponent);
